...
if args.logdir:
	writer = SummaryWriter(log_dir=args.logdir, comment='ResNet12', purge_step=0 if args.checkpoint_epoch is None else int(args.checkpoint_epoch*len(train_loader)))
