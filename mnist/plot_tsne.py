...
if __name__ == '__main__':
	...
	plt.savefig(os.path.join(args.out_path, args.out_prefix+'adv_emb_diff_max_hist_mnist.pdf'), bbox_inches='tight')
	plt.hist(emb_diff_mean, density=True, bins=30)
	plt.savefig(os.path.join(args.out_path, args.out_prefix+'adv_emb_diff_mean_hist_mnist.pdf'), bbox_inches='tight')
